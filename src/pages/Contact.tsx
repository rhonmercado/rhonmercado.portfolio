...
const socialLinks = [
    ...
    },
    {
        label: "GitHub",
        icon: Github,
        url: "https://github.com/rui5picious",
    },
    {
        label: "Facebook",
        icon: Facebook,
        url: "https://facebook.com/rui-profile",
    },
    {
        label: "Instagram",
        icon: Instagram,
        url: "https://instagram.com/rui5picious",
    },
];
...
const Contact: React.FC = () => {
    return (
        ...
        >
            ...
            {/* Contact Info */}
            <motion.div
                className="w-full flex flex-col md:flex-row items-center justify-center gap-10 text-white text-lg mb-20"
                initial="hidden"
                animate="visible"
                variants={{
